def handles(array)
  ...
  puts "Il y a #{array.size} handles"
end

def shortest_handle(array)
  puts "Quelle est le plus court handle de cette liste ?"
  puts "Le plus court handle est #{ array.min {|a,b| a.size <=> b.size}}"
end

def handle5(array)
  puts "Combien y a t-il de handle contenant 5 caractères ? (hors @)"
  puts "Il y a #{array.select {|elem| elem.length == 6}.size} handles avec 5 caractères"
end
